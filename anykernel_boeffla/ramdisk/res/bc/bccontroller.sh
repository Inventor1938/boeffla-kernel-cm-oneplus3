...
KERNEL_SPECS="oneplus3;cm;cm14.0;http://kernel.boeffla.de/oneplus3/boeffla-kernel-cm/;boeffla-kernel-#VERSION#-CM14.1-OnePlus3-anykernel.recovery.zip"
